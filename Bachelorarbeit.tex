...
\clearpage
\include{6Acronyms} %Abkürzungsverzeichnis
\clearpage
...
\include{8Grundlagen}
%\include{9Konzept}
\include{9Implementierung}
\include{10Untersuchung}
\include{11Bewertung}
...
%\include{11Evaluation}
%\thispagestyle{empty} \cleardoublepage 
%\include{12Zusammenfassung}
%\thispagestyle{empty} \cleardoublepage
...
\include{14Anhang} %Anhang idR nach Literaturverzeichnis, kann aber auch davor
%------ end of document ------
\end{document}